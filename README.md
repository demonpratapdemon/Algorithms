...
5. **Maximum & Minimum No b/w 2 nodes in BST** : Finding the maximum and minimum number betwee 2 nodes of BST if there exists a unique path using LCA(Least Common Ancestor)